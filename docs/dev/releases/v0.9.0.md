...
- Windows, Linux, and experimental macOS packaging now carry stronger runtime and symbol-validation checks, making release artifacts easier to install and diagnose.
