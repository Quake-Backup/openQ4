...
and face; unsupported special nesting retains its complete classic owner.
...
implementation target is **Milestone D unsupported special-view nesting ownership**,
...
9. **Implemented for special subviews:** a direct `SS_SUBVIEW` mirror record
   ...
   transfer returns. Unsupported nested, cinematic, or other special views
   retain their untouched classic owners pending dedicated semantic records.
...
The next implementation target is unsupported special-view nesting ownership,
