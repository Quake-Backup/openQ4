...
| Settings → Display → Advanced Rendering | Lens Flares | choice | `r_lensFlare` | `0, 1, 2` | Repo-verified `0..2` | `#str_41117` / `#str_41118` | Good direct binding |
...
- The modularization item is implemented for the planned Settings split: the Controls pane lives in `content/baseoq4/guis/menu/settings/controls.gui`, the System pane lives in `content/baseoq4/guis/menu/settings/system.gui`, the Audio pane lives in `content/baseoq4/guis/menu/settings/audio.gui`, and shared Settings popup widgets live in `content/baseoq4/guis/menu/settings/popups.gui`, leaving `mainmenu.gui` focused on the menu shell, shared events, animations, and global popups.
