...
- Current official macOS release artifacts are Apple Silicon/arm64 only. Intel Mac and universal2 packages are intentionally not claimed until the project adds a dedicated Intel validation runner or a universal packaging lane with architecture-specific launch checks.
