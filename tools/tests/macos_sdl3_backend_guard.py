...
def validate_macos_process_handoff_guards() -> None:
    ...
    require(start_process, "char *const emptyEnvironment[] = { NULL };", "macOS process handoff environment guard")
    require(start_process, "char ***environmentPointer = _NSGetEnviron();", "macOS process handoff environment guard")
    require(start_process, "environmentPointer != NULL && *environmentPointer != NULL", "macOS process handoff environment guard")
    require(start_process, "posix_spawnp( &childPid, argv[0], NULL, NULL, argv, environment )", "macOS process handoff environment guard")
